...
public class CellLayout extends ViewGroup {
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        //A:luobiao@wind-mobi.com 2015-7-13
        if( child instanceof FolderIcon){
            FolderIcon folderChild = (FolderIcon) child;
            folderChild.setTextVisible(true);
        }
        //A:luobiao@wind-mobi.com 2015-7-13 end
        ...
        if (lp.cellX >= 0 && lp.cellX <= mCountX - 1 && lp.cellY >= 0 && lp.cellY <= mCountY - 1) {
            ...
            child.setId(childId);
            //A:luobiao@wind-mobi.com 2015-7-27
            if(LauncherAppState.themeKey && lp.cellHSpan == 1 && lp.cellVSpan == 1){
                Animation mAlphaAnimation = new AlphaAnimation(0.1f, 1.0f);
                mAlphaAnimation.setDuration(250);
                mShortcutsAndWidgets.startAnimation(mAlphaAnimation);
            }
            //A:luobiao@wind-mobi.com 2015-7-27
