...
import com.wos.launcher3.Workspace.State;
...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected static final int OVER_SCROLL_PAGE_SNAP_ANIMATION_DURATION = 550;
    ...
    private static final float SIGNIFICANT_MOVE_THRESHOLD = 0.1f;
    ...
    //A : zhangxutong@wind-mobi.com 2015 07 06 begin
    private float mLastX,mLastY;
    private boolean isExpanded ;
    //A : zhangxutong@wind-mobi.com 2015 07 06 end
    //A:luobiao@wind-mobi.com 20151201 -b
    protected boolean overshootEffect = false;
    ...
    protected void init() {
        ...
        //M:luobiao@wind-mobi.com 20151201 -b
        //mTouchSlop = configuration.getScaledPagingTouchSlop();
        mTouchSlop = configuration.getScaledPagingTouchSlop()/2;
        //M:luobiao@wind-mobi.com 20151201 -e
    ...
    void setCurrentPage(int currentPage) {
        ...
        notifyPageSwitchListener();
        Log.d("LauncherScroll","PagedView:setCurrentPage:invalidate");
        invalidate();
    }
    ...
    public void scrollTo(int x, int y) {
        ...
        if (isXBeforeFirstPage) {
            Log.d("LauncherScroll","scrollTo1");
            super.scrollTo(0, y);
            if (mAllowOverScroll) {
                if (isRtl) {
            ...
            Log.d("LauncherScroll","scrollTo2");
            ...
            Log.d("LauncherScroll","scrollTo3");
            mOverScrollX = x;
            super.scrollTo(x, y);
    ...
    protected boolean computeScrollHelper() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (getScrollX() != mScroller.getCurrX()
                ...
                Log.d("LauncherScroll","PagedView:computeScrollHelper:scrollX:"+scrollX+",getCurrY"+mScroller.getCurrY());
                scrollTo(scrollX, mScroller.getCurrY());
            }else{
                invalidate();
            }
            //luobiao@wind-mobi.com 20160120 -b
            if(mLauncher.getWorkspace().workspaceInModalState()){
                Log.d("LauncherScroll","PagedView:computeScrollHelper:scrollX:invalidate");
                invalidate();
            }
            //luobiao@wind-mobi.com 20160120 -e
            return true;
        } else if (mNextPage != INVALID_PAGE) {
            Log.d("LauncherScroll","PagedView:computeScrollHelper:INVALID_PAGE");
    ...
    protected void screenScrolled(int screenCenter) {
        ...
        if (mFadeInAdjacentScreens && !isInOverscroll) {
            ...
            Log.d("LauncherScroll","PagedView:screenScrolled:invalidate");
            invalidate();
        }
    }
    ...
    public void onChildViewAdded(View parent, View child) {
        ...
        Log.d("LauncherScroll","PagedView:onChildViewAdded:invalidate");
        invalidate();
    }
    ...
    public void onChildViewRemoved(View parent, View child) {
        mForceScreenScrolled = true;
        updateFreescrollBounds();
        Log.d("LauncherScroll","PagedView:onChildViewRemoved:invalidate");
        invalidate();
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (pageCount > 0) {
            ...
            if (leftScreen != -1 && rightScreen != -1) {
                ...
                for (int i = pageCount - 1; i >= 0; i--) {
                    ...
                    //M:luobiao@wind-mobi.com 2015-8-24
        ...
        if(getPageAt(mCurrentPage) != null){
            getPageAt(mCurrentPage).getLocationOnScreen(location);
            xx = location[0];
            yy = location[1];
            int time = (int)(System.currentTimeMillis());
            Log.d("LauncherScroll", "time:"+time+",x:"+xx);
            Log.d("Pointer","Launcher:time:"+time+",x"+xx);
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                //A: zhangxutong@wind-mobi.com 2015 07 06 begin
                if(ev.getY()-mLastMotionY>300 && !isExpanded && !mFreeScroll && !mLauncher.getWorkspace().workspaceInModalState())
                {
                    Log.i("zhangxutong/PagedView", "expandNotificationsPanel");
                    isExpanded = true ;
                    try {
                        ...
                        Log.i("zhangxutong/PagedView", "Exception");
                        e.printStackTrace();
                    }
                }
                //A: zhangxutong@wind-mobi.com 2015 07 06 end
                ...
                if (mActivePointerId != INVALID_POINTER) {
                    int time = (int)(System.currentTimeMillis());
                    Log.d("LauncherScroll","PagedView:onInterceptTouchEvent:move:"+time);
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if(getPageAt(mCurrentPage) != null){
                    ...
                    yy = location[1];
                    int time = (int)(System.currentTimeMillis());
                    Log.d("LauncherScroll:down", "time:"+time+",x:"+xx+","+mTouchSlop);
                    Log.d("Pointer:","Launcher down:time:"+time+",x"+xx);
                }
    ...
    protected void determineScrollingStart(MotionEvent ev, float touchSlopScale) {
        ...
        if (xMoved || xPaged || yMoved) {
            if (mUsePagingTouchSlop ? xPaged : xMoved) {
                ...
                mTouchState = TOUCH_STATE_SCROLLING;
                int time = (int)(System.currentTimeMillis());
                Log.d("LauncherScroll","pagedView:determineScrollingStart:TOUCH_STATE_SCROLLING:"+time);
    ...
    protected void dampedOverScroll(float amount) {
        ...
        Log.d("LauncherScroll","PagedView:dampedOverScroll:invalidate");
        invalidate();
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                int timedown = (int)(System.currentTimeMillis());
                Log.d("LauncherScroll:DOWN","Touch move:"+timedown);
            /*
            ...
            case MotionEvent.ACTION_MOVE:
                int time = (int)(System.currentTimeMillis());
                Log.d("LauncherScroll:MOVE","Touch move:"+time);
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    if (Math.abs(deltaX) >= 1.0f) {
                        ...
                        if (!mDeferScrollUpdate) {
                            //M:luobiao@wind-mobi.com 20150127 -b
                            if(LauncherAppState.effectIndex == 9){
                                scrollBy((int)( deltaX *1.2), 0);
                            }else{
                                scrollBy((int)deltaX, 0);
                            }
                            //M:luobiao@wind-mobi.com 20150127 -e
            ...
            case MotionEvent.ACTION_UP:
                Log.d("LUOBIAO","Touch up:"+ev.getX()+","+ev.getY());
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    Log.d("LUOBIAO","Touch view:velocityX:"+velocityX);
                    ...
                    if (!mFreeScroll) {
                        ...
                        Log.d("LauncherScroll","PagedView:onTouchEvent:up:invalidate");
                        invalidate();
                    }
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        Log.d("LUOBIAO", "PagedView:onGenericMotionEvent");
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        yy = location[1];
        int time = (int)(System.currentTimeMillis());
        Log.d("LauncherScroll:snapToPageWithVelocity", "time:"+time+",x:"+xx);
        ...
        if (Math.abs(velocity) < mMinFlingVelocity || isInOverScroll()) {
            ...
            Log.d("LauncherScroll","velocity is low enough");
        ...
        Log.d("LauncherScroll","duration:"+duration);
    ...
    protected void snapToPage(int whichPage, int delta, int duration, boolean immediate,
        ...
        //A:luobiao@wind-mobi.com 20151130 begin
        if(overshootEffect){
            mScroller.setInterpolator(new OvershootInterpolator(2f));
        }
        //A:luobiao@wind-mobi.com 20151130 end
        ...
        mForceScreenScrolled = true;
        Log.d("LauncherScroll","PagedView:snapToPage:invalidate");
        //invalidate();
    }
    ...
    protected void onStartReordering() {
        ...
        Log.d("LauncherScroll","PagedView:onStartReordering:invalidate");
        invalidate();
    }
