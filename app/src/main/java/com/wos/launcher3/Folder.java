...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected void onFinishInflate() {
            ...
            public boolean onTouch(View arg0, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        float Xyd = Math.abs(event.getX() - Xpoint);
                        float Yyd = Math.abs(event.getY() - Ypoint);
                        if(Xyd+Yyd < 5){
        ...
        //A:luobiao@wind-mobi.com 2015-7-15
        if(LauncherAppState.WOS_FOLDER_KEY){
            mFolderName.setHighlightColor(Color.argb(100, 100, 100, 100));
        }
        //A:luobiao@wind-mobi.com 2015-7-15
    ...
    public void doneEditingFolderName(boolean commit) {
        //A:luobiao@wind-mobi.com 2015-9-1 begin
        sHintText = getResources().getString(R.string.folder_hint_text);
        //A:luobiao@wind-mobi.com 2015-9-1 end
    ...
    public void animateOpen() {
        //M:luobiao@wind-mobi.com 2015-8-14 Update unread number of content shortcuts.@{**/
        ...
        if (!Utilities.isLmpOrAbove()){
            //if (!Utilities.isLmpOrAbove() || LauncherAppState.getInstance().isPowerSaveMode()) {
        ...
        openFolderAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                /// M:luobiao@wind-mobi.com 2015-8-17 if open folder animation ended, set alpha and scale as 1 @{
                setAlpha(1f);
                setScaleX(1f);
                setScaleY(1f);
                /// end @}
        ...
        //A:luobiao@wind-mobi.com 2015-7-15
        openFolderAnim.setDuration(mExpandDuration);
        //A:luobiao@wind-mobi.com 2015-7-15
    ...
    protected View createAndAddShortcut(ShortcutInfo item) {
        ...
        // M:luobiao@wind-mobi.com 2015-8-14 Modified for Unread feature. Update unread number of folder icon.@**/
    ...
    private void centerAboutIcon() {
        ...
        //M:luobiao@wind-mobi.com 2015-7-15 end
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //M:luobiao@wind-mobi.com 2015-7-15
        if(LauncherAppState.WOS_FOLDER_KEY){
            mFolderName.measure(MeasureSpec.makeMeasureSpec(contentAreaWidthSpec, MeasureSpec.EXACTLY),
    ...
    //A:luobiao@wind-mobi.com 2015-8-14 Update unread number of the content shortcut.
