...
public abstract class SmoothPagedView extends PagedView {
    ...
    protected void init() {
        super.init();
        Log.d("LUOBIAO", "SmoothPagedView:mScrollMode="+mScrollMode);
    ...
    public void computeScroll() {
        if (mScrollMode == X_LARGE_MODE) {
            Log.d("LauncherSrcoll","SmoothPagedView:super.computeScroll()");
            super.computeScroll();
        } else {
            Log.d("LauncherSrcoll","SmoothPagedView:super.computeScroll():else");
