...
public class InstallShortcutReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent data) {
        Log.d("LUOBIAO", "InstallShortcutReceiver:onReceive"+data.getAction());
        ...
        //A:luobiao@wind-mobi.com 20151126 -b
        if(LauncherAppState.SHORTCUT_THEME_KEY){
            BitmapDrawable mIcon = (BitmapDrawable)app.getIconCache().getDrawableResource(intent.getComponent().getPackageName(), intent.getComponent().getClassName());
            if(mIcon != null){
                info.icon = mIcon.getBitmap();
            }
        }
        //A:luobiao@wind-mobi.com 20151126 -e
    ...
    static void flushInstallQueue(Context context) {
        Log.d("LUOBIAO", "InstallShortcutReceiver:flushInstallQueue");
        String spKey = LauncherAppState.getSharedPreferencesKey();
        SharedPreferences sp = context.getSharedPreferences(spKey, Context.MODE_PRIVATE);
        ...
        if (!installQueue.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                /* D:luobiao@wind-mobi.com 2015-9-18 begin
            ...
            if (!addShortcuts.isEmpty()) {
                Log.d("LUOBIAO", "InstallShortcutReceiver:!addShortcuts.isEmpty()");
                LauncherAppState app = LauncherAppState.getInstance();
    ...
    static boolean isValidShortcutLaunchIntent(Intent launchIntent) {
        //M:luobiao@wind-mobi.com 2015-7-13
