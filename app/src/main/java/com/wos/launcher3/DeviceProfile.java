...
public class DeviceProfile {
    ...
    DeviceProfile(String n, float w, float h, float r, float c,
        ...
        iconTextSize = its;
        numHotseatIcons = hs;
        //M:luobiao@wind-mobi.com 2015-7-10
        hotseatIconSize = is;
        //hotseatIconSize = his;
        //M:luobiao@wind-mobi.com 2015-7-10
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources resources,
        ...
        hotseatBarHeightPx = iconSizePx + 6 * edgeMarginPx + 64;
        hotseatCellWidthPx = cellHeightPx;
        //M:luobiao@wind-mobi.com 2015-7-13
        ...
        if(LauncherAppState.WOS_FOLDER_KEY){
            folderCellWidthPx = cellWidthPx + 7 * edgeMarginPx;
            folderCellHeightPx = cellHeightPx + 2 * edgeMarginPx;
        }else{
            folderCellWidthPx = cellWidthPx + 3 * edgeMarginPx;
            folderCellHeightPx = cellHeightPx + 3 * edgeMarginPx;
        }
