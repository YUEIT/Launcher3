...
import com.wos.launcher3.FolderInfo.FolderListener;
...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        //A:luobiao@wind-mobi.com 2015-7-30

        if(context!=null){
            Drawable drawable = iconCache.getDrawableResource("com.wos.launcher3.drawable_FolderPreviewBackground", "com.wos.launcher3.drawable_FolderPreviewBackground");
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sSharedOuterRingDrawable = res.getDrawable(R.drawable.portal_ring_outer_holo_wos);
                ...
                if(launcher!=null){
                    ...
                    switch(index){
                        ...
                        case 3:sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo5);break;
                        case 4:sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo3);break;
                        case 5:sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo2);break;
                        case 6:sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo6);break;
                        default :sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_nolip_holo6);break;
                    }
                }
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        if(true){
            ...
            int transEdgeY = res.getInteger(R.integer.folder_edge_margin_y);
            int transEdgeX = res.getInteger(R.integer.folder_edge_margin_x);
            int itemEdgeX = res.getInteger(R.integer.folder_item_edge_margin_x);
            int itemEdgeY = res.getInteger(R.integer.folder_item_edge_margin_y);
            float r = (indexX * 1.0f)/(2);
            float scale = (1 - PERSPECTIVE_SCALE_FACTOR * r);
            float offset = r * mMaxPerspectiveShift;
            float scaledSize = scale * mBaselineIconSize;
            float scaleOffsetCorrection = (1 - scale) * mBaselineIconSize;
            float maxPaddingY = 1.0f * mMaxPerspectiveShift + mBaselineIconSize - itemEdgeY;
            float transY = maxPaddingY * indexY / 3 + getPaddingTop() + transEdgeY;
            float transX = offset + scaleOffsetCorrection + itemEdgeX * indexX + transEdgeX;
            float totalScale = (mBaselineIconScale/7)*2;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        //M:luobiao@wind-mobi.com 2015-8-14 Draw unread event number.
        WOSUnreadLoader.drawUnreadEventIfNeed(canvas, this);
    ...
    public void onAdd(ShortcutInfo item) {
        /**
         * M:luobiao@wind-mobi.com 2015-8-14 added for unread feature, when add a item to a folder, we need to update
    ...
    public void onRemove(ShortcutInfo item) {
        /**M:luobiao@wind-mobi.com 2015-8-14 added for Unread feature, when remove a item from a folder, we need to update
         *  the unread num of the folder.@{
         */
        final ComponentName componentName = item.intent.getComponent();
        updateFolderUnreadNum(componentName, item.unreadNum);
    ...
    public void updateFolderUnreadNum() {
        ...
        for (int i = 0; i < contentsCount; i++) {
            ...
            unreadNum = WOSUnreadLoader.getUnreadNumberOfComponent(componentName);
            if (unreadNum > 0) {
