...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        //A:luobiao@wind-mobi.com 2015-7-10 begin
        ...
        //A:luobiao@wind-mobi.com 2015-7-10 end
        ...
        if (useUninstallLabel) {
            ...
            //M:luobiao@wind-mobi.com 2015-7-10 begin
            if(true){
                setCompoundDrawablesRelativeWithIntrinsicBounds(mUninstallDrawable, null, null, null);
            }else{
                setCompoundDrawablesRelativeWithIntrinsicBounds(mRemoveDrawable, null, null, null);
            }
            //M:luobiao@wind-mobi.com 2015-7-10 end
        } else {
            isVisible = false;
        }
        mCurrentDrawable = (TransitionDrawable) getCurrentDrawable();
    ...
    private boolean isUninstallFromWorkspace(DragObject d) {
        if (LauncherAppState.isDisableAllApps() && isWorkspaceOrFolderApplication(d)) {
            ...
            //A:luobiao@wind-mobi.com 2015-9-18 begin
            if(shortcut.itemType == LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT){
                return false;
            }
            //A:luobiao@wind-mobi.com 2015-9-18 end
