...
import com.wos.launcher3.AutoInstallsLayout.LayoutParserCallback;
...
import com.wos.launcher3.config.ProviderConfig;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static String getAttributeValue(XmlResourceParser parser, String attribute) {
        String value = parser.getAttributeValue(
                "http://schemas.android.com/apk/res-auto/com.wos.launcher3", attribute);
        if (value == null) {
